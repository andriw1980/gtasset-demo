...
import { Search, Filter, AlertTriangle, Calendar, Shield, ShieldCheck, Upload, Send, Eye } from 'lucide-react';
    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <h1 className="text-3xl font-bold">Corrective Maintenance & Loss Reporting</h1>
        </div>

        <Tabs defaultValue="maintenance" className="w-full">
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="maintenance">Corrective Maintenance</TabsTrigger>
            <TabsTrigger value="loss-report">Loss & Incident Reporting</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="loss-report" className="space-y-6">
            <div className="flex items-center space-x-2">
              <AlertTriangle className="h-8 w-8 text-destructive" />
              <h2 className="text-2xl font-bold">Loss & Incident Reporting</h2>
            </div>
